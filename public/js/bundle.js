...
exports.verifyOtp = exports.signup = exports.resetPassword = exports.logout = exports.login = exports.forgotPassword = void 0;
      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "log in successful");
    ...
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        ...
        case 1:
          res = _context3.v;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "OTP sent! Please check your email.");
            window.setTimeout(function () {
              location.assign("/verify?email=".concat(email));
            }, 1500);
          }
          _context3.n = 3;
          break;
        case 2:
          ...
          _t3 = _context3.v;
          console.log(_t3);
          (0, _alert.showAlert)("error", _t3.response.data.message);
        case 3:
...
var verifyOtp = exports.verifyOtp = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(email, otp) {
    var res, _t4;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.p = _context4.n) {
        ...
        case 1:
          res = _context4.v;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Account verified! Logging in...");
            window.setTimeout(function () {
              location.assign("/");
            }, 1500);
          }
        ...
        case 2:
          ...
          _t4 = _context4.v;
          console.log(_t4);
          (0, _alert.showAlert)("error", _t4.response.data.message);
        case 3:
          return _context4.a(2);
      }
    }, _callee4, null, [[0, 2]]);
  }));
  return function verifyOtp(_x7, _x8) {
    return _ref4.apply(this, arguments);
  };
}();
var forgotPassword = exports.forgotPassword = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee5(email) {
    var res, _t5;
    return _regenerator().w(function (_context5) {
      while (1) switch (_context5.p = _context5.n) {
        ...
        case 1:
          res = _context5.v;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Email sent successfully! Check your inbox.");
          }
          _context5.n = 3;
          break;
        case 2:
          _context5.p = 2;
          _t5 = _context5.v;
          (0, _alert.showAlert)("error", _t5.response.data.message);
        case 3:
...
var resetPassword = exports.resetPassword = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(token, password, passwordConfirm) {
    var res, _t6;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.p = _context6.n) {
        ...
        case 2:
          _context6.p = 2;
          _t6 = _context6.v;
          (0, _alert.showAlert)("error", _t6.response.data.message);
        case 3:
          return _context6.a(2);
      }
    }, _callee6, null, [[0, 2]]);
  }));
  return function resetPassword(_x0, _x1, _x10) {
    return _ref6.apply(this, arguments);
  };
}();
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"updateSetings.js":[function(require,module,exports) {
"use strict";
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          // console.log(res);
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "".concat(type.toUpperCase(), " date successfuly"));
            window.setTimeout(function () {
              location.reload();
            }, 1000);
          }
...
var createReview = exports.createReview = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(mealId, review, rating) {
    var res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: "POST",
            url: "/api/v1/meals/".concat(mealId, "/reviews"),
            data: {
              review: review,
              rating: rating
            }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"admin.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateOrderStatus = exports.initAdminTabs = exports.deleteData = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var initAdminTabs = exports.initAdminTabs = function initAdminTabs() {
    ...
    sideNavItems.forEach(function (item) {
      item.addEventListener("click", function () {
        sideNavItems.forEach(function (el) {
          return el.classList.remove("side-nav__item--active");
        });
...
var deleteData = exports.deleteData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(id, type) {
    var confirmed, res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
        ...
        case 1:
          ...
          return (0, _axios.default)({
            method: "DELETE",
            url: "/api/v1/".concat(type, "/").concat(id)
          });
        case 2:
          res = _context.v;
          if (res.status === 204) {
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          (0, _alert.showAlert)("error", "Error deleting item! Try again.");
        case 4:
          return _context.a(2);
      }
    }, _callee, null, [[0, 3]]);
  }));
  return function deleteData(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        ...
        case 1:
          res = _context2.v;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Order status updated successfully!");
          }
          _context2.n = 3;
          break;
        case 2:
          _context2.p = 2;
          _t2 = _context2.v;
          (0, _alert.showAlert)("error", "Error updating status");
          console.error(_t2);
        case 3:
          return _context2.a(2);
      }
...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"mangeMeal.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.saveMeal = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var saveMeal = exports.saveMeal = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type, mealId) {
    var url, method, res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          url = type === "create" ? "/api/v1/meals" : "/api/v1/meals/".concat(mealId);
        ...
        case 1:
          res = _context.v;
          if (res.data.status === "success") {
            (0, _alert.showAlert)("success", "Meal ".concat(type === "create" ? "created" : "updated", " successfully!"));
            window.setTimeout(function () {
  ...
  return function saveMeal(_x, _x2, _x3) {
    return _ref.apply(this, arguments);
  };
}();
...
exports.updateCartBadge = exports.getCart = exports.addToCart = void 0;
var addToCart = exports.addToCart = function addToCart(meal) {
  var cart = JSON.parse(localStorage.getItem("cart")) || [];
  var existingMeal = cart.find(function (item) {
...
var updateCartBadge = exports.updateCartBadge = function updateCartBadge() {
  var cart = getCart();
...
exports.bookMeal = exports.bookCart = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alert = require("./alert");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
var stripe = window.Stripe("pk_test_51SUqhpCEsT2n5ixkKhJbBopDmx0PfSjZ7ewiKNZL29WXB9GZebFQHFbwwekVJYBFL81w0Hx65kE9XSSAMvdAzZ9n00wlKYE7tj");
var bookMeal = exports.bookMeal = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(mealId) {
    var session, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("/api/v1/bookings/checkout-session/".concat(mealId));
        case 1:
          session = _context.v;
          _context.n = 2;
  ...
  return function bookMeal(_x) {
    return _ref.apply(this, arguments);
  };
}();
var bookCart = exports.bookCart = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(cart) {
    var session, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          _context2.n = 1;
          return _axios.default.post("/api/v1/bookings/checkout-cart", {
            cart: cart
          });
        case 1:
          session = _context2.v;
...
var _mangeMeal = require("./mangeMeal");
var _alert = require("./alert");
...
var userPhotoPreview = document.querySelector(".form__user-photo");
...
var bookBtn = document.getElementById("book-meal");
var otpForm = document.querySelector(".form--otp");
if (photoInput) {
...
if (userDataForm) {
  userDataForm.addEventListener("submit", function (e) {
    ...
    (0, _updateSetings.updateSettings)(form, "data");
  });
}
if (userPasswordForm) {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            ...
            _context.n = 1;
            return (0, _updateSetings.updateSettings)({
...
if (resetPasswordForm) {
  resetPasswordForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var btn = document.querySelector(".btn--reset-password");
...
if (reviewForm) {
  reviewForm.addEventListener("submit", function (e) {
    ...
    var mealId = reviewForm.dataset.mealId;
    if (!rating) {
      alert("Please select a star rating!");
      return;
    }
    var btn = reviewForm.querySelector("button");
    btn.textContent = "Submitting...";
    (0, _reviews.createReview)(mealId, review, rating);
  });
}
if (bookBtn) {
  bookBtn.addEventListener("click", function (e) {
    ...
    var mealId = e.target.dataset.mealId;
    (0, _stripe.bookMeal)(mealId);
  });
}
if (otpForm) {
...
if (deleteBtns) {
  deleteBtns.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      ...
      (0, _admin.deleteData)(id, type);
    });
  });
}
var mealForm = document.querySelector(".form--meal-data");
if (mealForm) {
  mealForm.addEventListener("submit", function (e) {
    e.preventDefault();
    var mealId = mealForm.dataset.id;
    var type = mealId ? "update" : "create";
    var form = new FormData();
    form.append("name", document.getElementById("name").value);
    ...
    (0, _mangeMeal.saveMeal)(form, type, mealId);
  });
}
var statusSelects = document.querySelectorAll(".order-status");
if (statusSelects) {
  statusSelects.forEach(function (select) {
    select.addEventListener("change", function (e) {
      var id = e.target.dataset.id;
      var status = e.target.value;
      (0, _admin.updateOrderStatus)(id, status);
      e.target.className = "order-status status-".concat(status);
    });
  });
}
  ...
  addToCartBtns.forEach(function (btn) {
    btn.addEventListener("click", function (e) {
      ...
      var _e$target$dataset = e.target.dataset,
        mealId = _e$target$dataset.mealId,
        mealName = _e$target$dataset.mealName,
        mealPrice = _e$target$dataset.mealPrice,
        mealImage = _e$target$dataset.mealImage;
      (0, _cart.addToCart)({
        id: mealId,
        name: mealName,
        price: mealPrice,
...
if (cartContainer) {
  ...
  if (cart.length === 0) {
    ...
    cart.forEach(function (item) {
      ...
      var html = "\n        <div class=\"cart-item\">\n          <img src=\"/img/meals/".concat(item.image, "\" alt=\"").concat(item.name, "\" class=\"cart-img\" />\n          <div class=\"cart-details\">\n            <h3>").concat(item.name, "</h3>\n            <p>$").concat(item.price, "</p>\n          </div>\n        </div>\n      ");
